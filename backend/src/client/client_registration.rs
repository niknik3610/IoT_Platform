...
use self::client_registration_service::{DeviceCapabilityStatus, RegistrationRequest};
...
//TODO: take in static array of Capability and device name and any other user set options
